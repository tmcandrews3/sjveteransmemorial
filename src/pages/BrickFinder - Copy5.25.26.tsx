...
export default function BrickFinder() {
  ...
  return (
    <div className="min-h-screen bg-[#0a1625] text-white">
      ...
      {/* Search Section with Instructions */}
      <div className="max-w-3xl mx-auto px-6 -mt-10 relative z-20">
        ...
        {/* Search Box */}
        <div 
          className="bg-gray-900 rounded-3xl p-6 shadow-2xl border border-gray-700 cursor-pointer"
          ...
          <div className="flex items-center bg-gray-950 rounded-2xl px-6 py-5">
            ...
            {searchTerm && (
              <button 
                ...
                className="ml-3 flex items-center gap-2 bg-gray-800 hover:bg-gray-700 px-4 py-2 rounded-xl text-sm font-medium text-gray-300"
              >
                <X size={20} />
                CLEAR
              </button>
        ...
        {/* Hint when a brick is selected */}
        {selectedBrick && (
          <div className="text-center mt-4">
            <p className="text-gray-400 text-sm">
              Tap the search box or click CLEAR to start a new search
            </p>
          </div>
        )}
...
{selectedBrick && (
        <div className="max-w-7xl mx-auto px-6 py-12">
          ...
          <div className="flex justify-center mb-12">
            <div className="w-full max-w-[620px]">
              <div 
                className="bg-[#f05f33] aspect-[2/1] rounded-3xl shadow-2xl border-8 border-[#c14a28] flex items-center justify-center p-8 text-center relative overflow-hidden"
                style={{ fontFamily: 'system-ui, -apple-system, sans-serif' }}
              >
                <div className="space-y-3 text-[#010109] font-bold leading-tight text-[2.5rem]">
          ...
          {/* Information Box */}
          <div className="max-w-3xl mx-auto bg-gray-900 rounded-3xl p-10 border border-gray-400">
            {selectedBrick.sponsor && (
              <p className="text-blue-400 text-2xl mb-8 text-center">
                Sponsor: <span className="font-medium">{selectedBrick.sponsor}</span>
              </p>
            )}

            <div className="text-center">
              <div className="uppercase tracking-[4px] text-[1.5rem] text-gray-400 mb-6">BRICK LOCATION</div>
              
              <div className="text-6xl font-bold text-[#ffe887] mb-3">
      ...
      <footer className="bg-black/50 py-12 text-center text-gray-500">
        ...
        <div className="mt-2">
          ...
          <a 
            href="mailto:tmcandrews3@gmail.com" 
            className="text-blue-400 hover:underline"
          >
            tmcandrews3@gmail.com
          </a>
        </div>
      </footer>
    </div>
